<ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
	<li class="mb-3"><a href='<?php echo site_url("Master/masterrumah"); ?>' style="text-decoration: none; color: black">Rumah Dinas</a></li>
	<li class="mb-3"><a href='<?php echo site_url("Master/mastergedung"); ?>' style="text-decoration: none; color: black">Gedung UBS</a></li>
